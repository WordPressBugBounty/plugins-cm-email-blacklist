...
if (!class_exists(__NAMESPACE__ . '\CmindsFreePackageEB')) {

    class CmindsFreePackageEB {
		...
		*/
        ...
        public function enqueueAdminScripts() {
			...
			wp_enqueue_script('cmeb-custom', plugin_dir_url(__FILE__) . 'js/custom.js', array(), $this->getOption('plugin-version'), true);
            ...
            <div class="wrap">
                ...
                switch ($plugin_page) {
                    ...
                    case $currentPlugin->getPageSlug(): {
                            ...
                            wp_enqueue_script('cmeb-mailerlite', plugin_dir_url(__FILE__) . 'js/mailerlite.js', array(), $this->getOption('plugin-version'), true);
                            ob_start();
...
//						'30' => 'Upgrade Tutorial',
        ...
        <h2 class="nav-tab-wrapper">
            <a href="?page=cmeb_addons&tab=general" class="nav-tab <?php echo $active_tab === 'general' ? 'nav-tab-active' : ''; ?>">Free Plugins</a>
            <a href="?page=cmeb_addons&tab=advanced" class="nav-tab <?php echo $active_tab === 'advanced' ? 'nav-tab-active' : ''; ?>">Premium Plugins</a>
            <a href="?page=cmeb_addons&tab=extra" class="nav-tab <?php echo $active_tab === 'extra' ? 'nav-tab-active' : ''; ?>">Plugin Bundles</a>
           <a href="?page=cmeb_addons&tab=service" class="nav-tab <?php echo $active_tab === 'service' ? 'nav-tab-active' : ''; ?>">Web Services</a>
        </h2>
...
$cmindsPluginPackage[$cminds_plugin_config['plugin-abbrev']] = new CmindsFreePackageEB($cminds_plugin_config);
